...
<body>
        ...
        <img src="images/redcross.png" alt="Lebanese Red Cross" width="60" height="60">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a id="wrongConceptsItem" href="pdfViewerPage.php" class="nav-item nav-link active">مغالطات</a>
                    <a id="homeItem" href="index.php" class="nav-item nav-link">الرئيسية</a>
    ...
    <iframe id="pdfViewer" onload="$('.iframe-loading').css('display', 'none');" src="https://docs.google.com/viewer?srcid=15LO6S0ISVSOtW0VrahK_8YraVXOt2K6v&pid=explorer&efh=false&a=v&chrome=false&embedded=true" width="100%" height="100%"></iframe>
